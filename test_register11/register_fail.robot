...
密码为空                    ${EMPTY}        ${valid_password}   ${valid_repassword}     ${valid_email}
确认密码为空                ${valid_username}        ${valid_password}   ${valid_repassword}     ${valid_email}
email为空                  ${valid_username}        ${valid_password}   ${valid_repassword}     ${valid_email}
